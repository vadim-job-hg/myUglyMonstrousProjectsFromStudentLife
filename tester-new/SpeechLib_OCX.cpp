...
// $Rev: 34747 $
// File generated on 10.01.2015 18:14:37 from Type Library described below.
...
void __fastcall TSpNotifyTranslator::InitWin32Event(void* hEvent, long fCloseHandleOnRelease)
{
  GetDefaultInterface()->InitWin32Event(hEvent, fCloseHandleOnRelease);
}
...
void __fastcall TSpStreamFormatConverter::GetFormat(System::TGUID* pguidFormatId, 
                                                    Speechlib_tlb::WaveFormatEx** ppCoMemWaveFormatEx)
{
  GetDefaultInterface()->GetFormat(pguidFormatId, ppCoMemWaveFormatEx);
}
...
void __fastcall TSpStream::GetFormat(System::TGUID* pguidFormatId, 
                                     Speechlib_tlb::WaveFormatEx** ppCoMemWaveFormatEx)
{
  GetDefaultInterface()->GetFormat(pguidFormatId, ppCoMemWaveFormatEx);
}

void __fastcall TSpStream::SetBaseStream(Speechlib_tlb::IStream* pStream, System::TGUID* rguidFormat, 
                                         Speechlib_tlb::WaveFormatEx* pWaveFormatEx)
{
  GetDefaultInterface()->SetBaseStream(pStream, rguidFormat, pWaveFormatEx);
}

void __fastcall TSpStream::GetBaseStream(Speechlib_tlb::IStream** ppStream)
{
  GetDefaultInterface()->GetBaseStream(ppStream);
}

void __fastcall TSpStream::BindToFile(LPWSTR pszFileName, Speechlib_tlb::SPFILEMODE eMode, 
                                      System::TGUID* pFormatId, 
                                      Speechlib_tlb::WaveFormatEx* pWaveFormatEx, 
                                      unsigned_int64 ullEventInterest)
{
  GetDefaultInterface()->BindToFile(pszFileName, eMode, pFormatId, pWaveFormatEx, ullEventInterest);
}
...
void __fastcall TSpVoice::InvokeEvent(int id, Oleserver::TVariantArray& params)
{
  switch(id)
  {
    case 1: {
...
void __fastcall TSpSharedRecoContext::InvokeEvent(int id, Oleserver::TVariantArray& params)
{
  switch(id)
  {
    case 1: {
...
void __fastcall TSpCompressedLexicon::GetGeneration(unsigned_long* pdwGeneration)
{
  GetDefaultInterface()->GetGeneration(pdwGeneration);
}
...
void __fastcall TSpShortcut::GetGeneration(unsigned_long* pdwGeneration)
{
  GetDefaultInterface()->GetGeneration(pdwGeneration);
}
...
void __fastcall TSpPhoneticAlphabetConverter::SetLangId(unsigned_short LangId)
{
  GetDefaultInterface()->SetLangId(LangId);
}

void __fastcall TSpPhoneticAlphabetConverter::SAPI2UPS(unsigned_short* pszSAPIId/*[in]*/, 
                                                       unsigned_short* pszUPSId/*[out]*/, 
                                                       unsigned_long cMaxLength)
{
  GetDefaultInterface()->SAPI2UPS(pszSAPIId/*[in]*/, pszUPSId/*[out]*/, cMaxLength);
}
...
void __fastcall TSpPhoneticAlphabetConverter::UPS2SAPI(unsigned_short* pszUPSId/*[in]*/, 
                                                       ...
                                                       unsigned_long cMaxLength)
{
  GetDefaultInterface()->UPS2SAPI(pszUPSId/*[in]*/, pszSAPIId/*[out]*/, cMaxLength);
}

void __fastcall TSpPhoneticAlphabetConverter::GetMaxConvertLength(unsigned_long cSrcLength, 
                                                                  long bSAPI2UPS, 
                                                                  unsigned_long* pcMaxDestLength/*[out]*/)
{
  GetDefaultInterface()->GetMaxConvertLength(cSrcLength, bSAPI2UPS, pcMaxDestLength/*[out]*/);
}
...
void __fastcall TSpNullPhoneConverter::SetObjectToken(Speechlib_tlb::ISpObjectToken* pToken)
{
  GetDefaultInterface()->SetObjectToken(pToken);
}

void __fastcall TSpNullPhoneConverter::GetObjectToken(Speechlib_tlb::ISpObjectToken** ppToken)
{
  GetDefaultInterface()->GetObjectToken(ppToken);
}
...
{
  Speechlib_tlb::ISpeechWaveFormatEx* WaveFormatEx = 0;
  OLECHECK(GetDefaultInterface()->GetWaveFormatEx((Speechlib_tlb::ISpeechWaveFormatEx**)&WaveFormatEx));
  return WaveFormatEx;
}

void __fastcall TSpAudioFormat::SetWaveFormatEx(Speechlib_tlb::ISpeechWaveFormatEx* WaveFormatEx/*[in]*/)
{
  GetDefaultInterface()->SetWaveFormatEx(WaveFormatEx/*[in]*/);
}
...
void __fastcall TSpInProcRecoContext::InvokeEvent(int id, Oleserver::TVariantArray& params)
{
  switch(id)
  {
    case 1: {
...
void __fastcall PACKAGE Register()
{
  ...
  RegisterComponents("SAPI", cls_svr,

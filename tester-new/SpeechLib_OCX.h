...
// *********************************************************************//
class PACKAGE TSpNotifyTranslator : public Oleserver::TOleServer
{
  ISpNotifyTranslatorPtr m_DefaultIntf;
  _di_IUnknown __fastcall GetDunk();
public:
  __fastcall TSpNotifyTranslator(TComponent* owner) : Oleserver::TOleServer(owner)
  {}
  ...
  void            __fastcall InitSpNotifyCallback(void** pSpCallback/*[in]*/, 
                                                  Speechlib_tlb::UINT_PTR wParam/*[in]*/, 
                                                  Speechlib_tlb::LONG_PTR lParam/*[in]*/);
  void            __fastcall InitWin32Event(void* hEvent, long fCloseHandleOnRelease);
...
// *********************************************************************//
class PACKAGE TSpObjectTokenCategory : public Oleserver::TOleServer
{
  ISpeechObjectTokenCategoryPtr m_DefaultIntf;
  _di_IUnknown __fastcall GetDunk();
public:
  __fastcall TSpObjectTokenCategory(TComponent* owner) : Oleserver::TOleServer(owner)
  {}
...
// TypeFlags        : (2) CanCreate
// *********************************************************************//
class PACKAGE TSpObjectToken : public Oleserver::TOleServer
{
  ISpeechObjectTokenPtr m_DefaultIntf;
  _di_IUnknown __fastcall GetDunk();
public:
  __fastcall TSpObjectToken(TComponent* owner) : Oleserver::TOleServer(owner)
  {}
...
// TypeFlags        : (530) CanCreate Hidden Restricted
// *********************************************************************//
class PACKAGE TSpResourceManager : public Oleserver::TOleServer
{
  ISpResourceManagerPtr m_DefaultIntf;
  _di_IUnknown __fastcall GetDunk();
public:
  __fastcall TSpResourceManager(TComponent* owner) : Oleserver::TOleServer(owner)
  {}
...
// TypeFlags        : (530) CanCreate Hidden Restricted
// *********************************************************************//
class PACKAGE TSpStreamFormatConverter : public Oleserver::TOleServer
{
  ISpStreamFormatConverterPtr m_DefaultIntf;
  _di_IUnknown __fastcall GetDunk();
public:
  __fastcall TSpStreamFormatConverter(TComponent* owner) : Oleserver::TOleServer(owner)
  {}
  ...
  void            __fastcall GetFormat(System::TGUID* pguidFormatId, 
...
// TypeFlags        : (530) CanCreate Hidden Restricted
// *********************************************************************//
class PACKAGE TSpMMAudioEnum : public Oleserver::TOleServer
{
  IEnumSpObjectTokensPtr m_DefaultIntf;
  _di_IUnknown __fastcall GetDunk();
public:
  __fastcall TSpMMAudioEnum(TComponent* owner) : Oleserver::TOleServer(owner)
  {}
...
// TypeFlags        : (2) CanCreate
// *********************************************************************//
class PACKAGE TSpMMAudioIn : public Oleserver::TOleServer
{
  ISpeechMMSysAudioPtr m_DefaultIntf;
  _di_IUnknown __fastcall GetDunk();
public:
  __fastcall TSpMMAudioIn(TComponent* owner) : Oleserver::TOleServer(owner)
  {}
...
// TypeFlags        : (2) CanCreate
// *********************************************************************//
class PACKAGE TSpMMAudioOut : public Oleserver::TOleServer
{
  ISpeechMMSysAudioPtr m_DefaultIntf;
  _di_IUnknown __fastcall GetDunk();
public:
  __fastcall TSpMMAudioOut(TComponent* owner) : Oleserver::TOleServer(owner)
  {}
...
// TypeFlags        : (530) CanCreate Hidden Restricted
// *********************************************************************//
class PACKAGE TSpStream : public Oleserver::TOleServer
{
  ISpStreamPtr m_DefaultIntf;
  _di_IUnknown __fastcall GetDunk();
public:
  __fastcall TSpStream(TComponent* owner) : Oleserver::TOleServer(owner)
  {}
  ...
  void            __fastcall GetFormat(System::TGUID* pguidFormatId, 
                                       Speechlib_tlb::WaveFormatEx** ppCoMemWaveFormatEx);
  void            __fastcall SetBaseStream(Speechlib_tlb::IStream* pStream, 
                                           System::TGUID* rguidFormat, 
                                           Speechlib_tlb::WaveFormatEx* pWaveFormatEx);
  void            __fastcall GetBaseStream(Speechlib_tlb::IStream** ppStream);
  void            __fastcall BindToFile(LPWSTR pszFileName, Speechlib_tlb::SPFILEMODE eMode, 
...
class PACKAGE TSpVoice : public Oleserver::TOleServer
{
  ISpeechVoicePtr m_DefaultIntf;
  _di_IUnknown __fastcall GetDunk();
public:
  __fastcall TSpVoice(TComponent* owner) : Oleserver::TOleServer(owner)
  {}
...
class PACKAGE TSpSharedRecoContext : public Oleserver::TOleServer
{
  ISpeechRecoContextPtr m_DefaultIntf;
  _di_IUnknown __fastcall GetDunk();
public:
  __fastcall TSpSharedRecoContext(TComponent* owner) : Oleserver::TOleServer(owner)
  {}
...
// TypeFlags        : (2) CanCreate
// *********************************************************************//
class PACKAGE TSpInprocRecognizer : public Oleserver::TOleServer
{
  ISpeechRecognizerPtr m_DefaultIntf;
  _di_IUnknown __fastcall GetDunk();
public:
  __fastcall TSpInprocRecognizer(TComponent* owner) : Oleserver::TOleServer(owner)
  {}
...
// TypeFlags        : (2) CanCreate
// *********************************************************************//
class PACKAGE TSpSharedRecognizer : public Oleserver::TOleServer
{
  ISpeechRecognizerPtr m_DefaultIntf;
  _di_IUnknown __fastcall GetDunk();
public:
  __fastcall TSpSharedRecognizer(TComponent* owner) : Oleserver::TOleServer(owner)
  {}
...
// TypeFlags        : (2) CanCreate
// *********************************************************************//
class PACKAGE TSpLexicon : public Oleserver::TOleServer
{
  ISpeechLexiconPtr m_DefaultIntf;
  _di_IUnknown __fastcall GetDunk();
public:
  __fastcall TSpLexicon(TComponent* owner) : Oleserver::TOleServer(owner)
  {}
...
// TypeFlags        : (2) CanCreate
// *********************************************************************//
class PACKAGE TSpUnCompressedLexicon : public Oleserver::TOleServer
{
  ISpeechLexiconPtr m_DefaultIntf;
  _di_IUnknown __fastcall GetDunk();
public:
  __fastcall TSpUnCompressedLexicon(TComponent* owner) : Oleserver::TOleServer(owner)
  {}
...
// TypeFlags        : (530) CanCreate Hidden Restricted
// *********************************************************************//
class PACKAGE TSpCompressedLexicon : public Oleserver::TOleServer
{
  ISpLexiconPtr m_DefaultIntf;
  _di_IUnknown __fastcall GetDunk();
public:
  __fastcall TSpCompressedLexicon(TComponent* owner) : Oleserver::TOleServer(owner)
  {}
  ...
  void            __fastcall RemovePronunciation(LPWSTR pszWord/*[in]*/, 
                                                 ...
                                                 Speechlib_tlb::SPPARTOFSPEECH ePartOfSpeech/*[in]*/, 
                                                 LPWSTR pszPronunciation/*[in]*/);
  void            __fastcall GetGeneration(unsigned_long* pdwGeneration);
...
// TypeFlags        : (2) CanCreate
// *********************************************************************//
class PACKAGE TSpShortcut : public Oleserver::TOleServer
{
  ISpShortcutPtr m_DefaultIntf;
  _di_IUnknown __fastcall GetDunk();
public:
  __fastcall TSpShortcut(TComponent* owner) : Oleserver::TOleServer(owner)
  {}
...
// TypeFlags        : (2) CanCreate
// *********************************************************************//
class PACKAGE TSpPhoneConverter : public Oleserver::TOleServer
{
  ISpeechPhoneConverterPtr m_DefaultIntf;
  _di_IUnknown __fastcall GetDunk();
public:
  __fastcall TSpPhoneConverter(TComponent* owner) : Oleserver::TOleServer(owner)
  {}
...
// TypeFlags        : (2) CanCreate
// *********************************************************************//
class PACKAGE TSpPhoneticAlphabetConverter : public Oleserver::TOleServer
{
  ISpPhoneticAlphabetConverterPtr m_DefaultIntf;
  _di_IUnknown __fastcall GetDunk();
public:
  __fastcall TSpPhoneticAlphabetConverter(TComponent* owner) : Oleserver::TOleServer(owner)
  {}
  ...
  void            __fastcall SetLangId(unsigned_short LangId);
  ...
  void            __fastcall GetMaxConvertLength(unsigned_long cSrcLength, long bSAPI2UPS, 
...
// TypeFlags        : (530) CanCreate Hidden Restricted
// *********************************************************************//
class PACKAGE TSpNullPhoneConverter : public Oleserver::TOleServer
{
  ISpPhoneConverterPtr m_DefaultIntf;
  _di_IUnknown __fastcall GetDunk();
public:
  __fastcall TSpNullPhoneConverter(TComponent* owner) : Oleserver::TOleServer(owner)
  {}
  ...
  void            __fastcall SetObjectToken(Speechlib_tlb::ISpObjectToken* pToken);
  void            __fastcall GetObjectToken(Speechlib_tlb::ISpObjectToken** ppToken);
...
// TypeFlags        : (2) CanCreate
// *********************************************************************//
class PACKAGE TSpTextSelectionInformation : public Oleserver::TOleServer
{
  ISpeechTextSelectionInformationPtr m_DefaultIntf;
  _di_IUnknown __fastcall GetDunk();
public:
  __fastcall TSpTextSelectionInformation(TComponent* owner) : Oleserver::TOleServer(owner)
  {}
...
// TypeFlags        : (2) CanCreate
// *********************************************************************//
class PACKAGE TSpPhraseInfoBuilder : public Oleserver::TOleServer
{
  ISpeechPhraseInfoBuilderPtr m_DefaultIntf;
  _di_IUnknown __fastcall GetDunk();
public:
  __fastcall TSpPhraseInfoBuilder(TComponent* owner) : Oleserver::TOleServer(owner)
  {}
...
// TypeFlags        : (2) CanCreate
// *********************************************************************//
class PACKAGE TSpAudioFormat : public Oleserver::TOleServer
{
  ISpeechAudioFormatPtr m_DefaultIntf;
  _di_IUnknown __fastcall GetDunk();
public:
  __fastcall TSpAudioFormat(TComponent* owner) : Oleserver::TOleServer(owner)
  {}
  ...
  void            __fastcall SetWaveFormatEx(Speechlib_tlb::ISpeechWaveFormatEx* WaveFormatEx/*[in]*/);
...
// TypeFlags        : (2) CanCreate
// *********************************************************************//
class PACKAGE TSpWaveFormatEx : public Oleserver::TOleServer
{
  ISpeechWaveFormatExPtr m_DefaultIntf;
  _di_IUnknown __fastcall GetDunk();
public:
  __fastcall TSpWaveFormatEx(TComponent* owner) : Oleserver::TOleServer(owner)
  {}
...
class PACKAGE TSpInProcRecoContext : public Oleserver::TOleServer
{
  ISpeechRecoContextPtr m_DefaultIntf;
  _di_IUnknown __fastcall GetDunk();
public:
  __fastcall TSpInProcRecoContext(TComponent* owner) : Oleserver::TOleServer(owner)
  {}
...
// TypeFlags        : (2) CanCreate
// *********************************************************************//
class PACKAGE TSpCustomStream : public Oleserver::TOleServer
{
  ISpeechCustomStreamPtr m_DefaultIntf;
  _di_IUnknown __fastcall GetDunk();
public:
  __fastcall TSpCustomStream(TComponent* owner) : Oleserver::TOleServer(owner)
  {}
...
// TypeFlags        : (2) CanCreate
// *********************************************************************//
class PACKAGE TSpFileStream : public Oleserver::TOleServer
{
  ISpeechFileStreamPtr m_DefaultIntf;
  _di_IUnknown __fastcall GetDunk();
public:
  __fastcall TSpFileStream(TComponent* owner) : Oleserver::TOleServer(owner)
  {}
...
// TypeFlags        : (2) CanCreate
// *********************************************************************//
class PACKAGE TSpMemoryStream : public Oleserver::TOleServer
{
  ISpeechMemoryStreamPtr m_DefaultIntf;
  _di_IUnknown __fastcall GetDunk();
public:
  __fastcall TSpMemoryStream(TComponent* owner) : Oleserver::TOleServer(owner)
  {}

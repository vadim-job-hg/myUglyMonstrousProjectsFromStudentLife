...
// $Rev: 34747 $
// File generated on 10.01.2015 18:19:40 from Type Library described below.
...
public:
  ...
  // [3] GetWaveFormatEx
  virtual HRESULT STDMETHODCALLTYPE GetWaveFormatEx(Speechlib_tlb::ISpeechWaveFormatEx** WaveFormatEx/*[out,retval]*/) = 0;
  // [4] SetWaveFormatEx
  virtual HRESULT STDMETHODCALLTYPE SetWaveFormatEx(Speechlib_tlb::ISpeechWaveFormatEx* WaveFormatEx/*[in]*/) = 0;
  ...
  Speechlib_tlb::ISpeechWaveFormatEx* __fastcall GetWaveFormatEx(void)
  {
    ...
    OLECHECK(this->GetWaveFormatEx((Speechlib_tlb::ISpeechWaveFormatEx**)&WaveFormatEx));
    return WaveFormatEx;
  }
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE InitWin32Event(void* hEvent, long fCloseHandleOnRelease) = 0; // [1610743811]
...
{
public:
  virtual HRESULT STDMETHODCALLTYPE SetData(LPWSTR pszValueName, unsigned_long cbData, 
                                            unsigned_char* pData) = 0; // [-1]
  virtual HRESULT STDMETHODCALLTYPE GetData(LPWSTR pszValueName, unsigned_long* pcbData, 
                                            unsigned_char* pData) = 0; // [-1]
  virtual HRESULT STDMETHODCALLTYPE SetStringValue(LPWSTR pszValueName/*[in]*/, LPWSTR pszValue) = 0; // [-1]
  virtual HRESULT STDMETHODCALLTYPE GetStringValue(LPWSTR pszValueName/*[in]*/, 
                                                   LPWSTR* ppszValue/*[out]*/) = 0; // [-1]
  virtual HRESULT STDMETHODCALLTYPE SetDWORD(LPWSTR pszValueName, unsigned_long dwValue) = 0; // [-1]
  virtual HRESULT STDMETHODCALLTYPE GetDWORD(LPWSTR pszValueName, unsigned_long* pdwValue) = 0; // [-1]
  virtual HRESULT STDMETHODCALLTYPE OpenKey(LPWSTR pszSubKeyName, 
                                            Speechlib_tlb::ISpDataKey** ppSubKey) = 0; // [-1]
  virtual HRESULT STDMETHODCALLTYPE CreateKey(LPWSTR pszSubKey, Speechlib_tlb::ISpDataKey** ppSubKey) = 0; // [-1]
  virtual HRESULT STDMETHODCALLTYPE DeleteKey(LPWSTR pszSubKey) = 0; // [-1]
  virtual HRESULT STDMETHODCALLTYPE DeleteValue(LPWSTR pszValueName/*[in]*/) = 0; // [-1]
  virtual HRESULT STDMETHODCALLTYPE EnumKeys(unsigned_long Index, LPWSTR* ppszSubKeyName/*[out]*/) = 0; // [-1]
  virtual HRESULT STDMETHODCALLTYPE EnumValues(unsigned_long Index, LPWSTR* ppszValueName/*[out]*/) = 0; // [-1]
};
...
{
public:
  virtual HRESULT STDMETHODCALLTYPE SetId(LPWSTR pszCategoryId/*[in]*/, long fCreateIfNotExist) = 0; // [1610743808]
  virtual HRESULT STDMETHODCALLTYPE GetId(LPWSTR* ppszCoMemCategoryId/*[out]*/) = 0; // [1610743809]
  virtual HRESULT STDMETHODCALLTYPE GetDataKey(Speechlib_tlb::SPDATAKEYLOCATION spdkl, 
                                               Speechlib_tlb::ISpDataKey** ppDataKey) = 0; // [1610743810]
...
{
public:
  virtual HRESULT STDMETHODCALLTYPE SetId(LPWSTR pszCategoryId, LPWSTR pszTokenId, 
                                          long fCreateIfNotExist) = 0; // [-1]
  virtual HRESULT STDMETHODCALLTYPE GetId(LPWSTR* ppszCoMemTokenId/*[out]*/) = 0; // [-1]
  virtual HRESULT STDMETHODCALLTYPE GetCategory(Speechlib_tlb::ISpObjectTokenCategory** ppTokenCategory) = 0; // [-1]
...
{
public:
  virtual HRESULT STDMETHODCALLTYPE GetFormat(System::TGUID* pguidFormatId, 
                                              Speechlib_tlb::WaveFormatEx** ppCoMemWaveFormatEx) = 0; // [1610809344]
};
...
{
public:
  virtual HRESULT STDMETHODCALLTYPE SetObjectToken(Speechlib_tlb::ISpObjectToken* pToken) = 0; // [-1]
  virtual HRESULT STDMETHODCALLTYPE GetObjectToken(Speechlib_tlb::ISpObjectToken** ppToken) = 0; // [-1]
};
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetMMHandle(void** pHandle) = 0; // [1610940418]
...
{
public:
  virtual HRESULT STDMETHODCALLTYPE SetBaseStream(Speechlib_tlb::IStream* pStream, 
                                                  System::TGUID* rguidFormat, 
                                                  Speechlib_tlb::WaveFormatEx* pWaveFormatEx) = 0; // [1610874880]
  virtual HRESULT STDMETHODCALLTYPE GetBaseStream(Speechlib_tlb::IStream** ppStream) = 0; // [1610874881]
  virtual HRESULT STDMETHODCALLTYPE BindToFile(LPWSTR pszFileName, Speechlib_tlb::SPFILEMODE eMode, 
                                               System::TGUID* pFormatId, 
                                               Speechlib_tlb::WaveFormatEx* pWaveFormatEx, 
                                               unsigned_int64 ullEventInterest) = 0; // [1610874882]
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE SetAlphabetToUPS(long fForceUPS) = 0; // [-1]
};
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE Pause(unsigned_long dwReserved) = 0; // [1610809354]
  virtual HRESULT STDMETHODCALLTYPE Resume(unsigned_long dwReserved) = 0; // [1610809355]
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE SetAdaptationData2(LPWSTR pAdaptationData/*[in]*/, 
                                                       unsigned_long cch, LPWSTR pTopicName/*[in]*/, 
                                                       unsigned_long eAdaptationSettings, 
                                                       Speechlib_tlb::SPADAPTATIONRELEVANCE eRelevance) = 0; // [-1]
};
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE ClearRule(void* hState) = 0; // [-1]
  virtual HRESULT STDMETHODCALLTYPE CreateNewState(void* hState, void** phState) = 0; // [-1]
  virtual HRESULT STDMETHODCALLTYPE AddWordTransition(void* hFromState, void* hToState, LPWSTR psz, 
                                                      LPWSTR pszSeparators, 
                                                      Speechlib_tlb::SPGRAMMARWORDTYPE eWordType, 
                                                      float Weight, 
                                                      Speechlib_tlb::SPPROPERTYINFO* pPropInfo) = 0; // [-1]
  virtual HRESULT STDMETHODCALLTYPE AddRuleTransition(void* hFromState, void* hToState, void* hRule, 
                                                      float Weight, 
                                                      Speechlib_tlb::SPPROPERTYINFO* pPropInfo) = 0; // [-1]
  virtual HRESULT STDMETHODCALLTYPE AddResource(void* hRuleState/*[in]*/, 
                                                LPWSTR pszResourceName/*[in]*/, 
                                                LPWSTR pszResourceValue/*[in]*/) = 0; // [-1]
  virtual HRESULT STDMETHODCALLTYPE Commit(unsigned_long dwReserved) = 0; // [-1]
};
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE SetRuleState(LPWSTR pszName/*[in]*/, void* pReserved, 
...
{
public:
  virtual HRESULT STDMETHODCALLTYPE GetAltInfo(Speechlib_tlb::ISpPhrase** ppParent, 
                                               unsigned_long* pulStartElementInParent, 
                                               unsigned_long* pcElementsInParent, 
                                               unsigned_long* pcElementsInAlt) = 0; // [-1]
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE SetTrainingState(long fDoingTraining, 
                                                     long fAdaptFromTrainingData) = 0; // [-1]
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE RemovePronunciation(LPWSTR pszWord/*[in]*/, 
                                                        ...
                                                        Speechlib_tlb::SPPARTOFSPEECH ePartOfSpeech/*[in]*/, 
                                                        LPWSTR pszPronunciation/*[in]*/) = 0; // [-1]
  virtual HRESULT STDMETHODCALLTYPE GetGeneration(unsigned_long* pdwGeneration) = 0; // [-1]
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetXMLErrorInfo(Speechlib_tlb::SPSEMANTICERRORINFO* pSemanticErrorInfo) = 0; // [-1]
};
...
public:
  ...
  HRESULT         __fastcall GetWaveFormatEx(Speechlib_tlb::ISpeechWaveFormatEx** WaveFormatEx/*[out,retval]*/);
  Speechlib_tlb::ISpeechWaveFormatEx* __fastcall GetWaveFormatEx(void);
  HRESULT         __fastcall SetWaveFormatEx(Speechlib_tlb::ISpeechWaveFormatEx* WaveFormatEx/*[in]*/);
...
public:
  ...
  HRESULT         __fastcall InitSpNotifyCallback(void** pSpCallback/*[in]*/, 
                                                  Speechlib_tlb::UINT_PTR wParam/*[in]*/, 
                                                  Speechlib_tlb::LONG_PTR lParam/*[in]*/);
  HRESULT         __fastcall InitWin32Event(void* hEvent, long fCloseHandleOnRelease);
...
public:
  ...
  HRESULT         __fastcall SetBaseStream(Speechlib_tlb::IStream* pStream, 
                                           System::TGUID* rguidFormat, 
                                           Speechlib_tlb::WaveFormatEx* pWaveFormatEx);
  HRESULT         __fastcall GetBaseStream(Speechlib_tlb::IStream** ppStream);
  HRESULT         __fastcall BindToFile(LPWSTR pszFileName, Speechlib_tlb::SPFILEMODE eMode, 
                                        System::TGUID* pFormatId, 
                                        Speechlib_tlb::WaveFormatEx* pWaveFormatEx, 
                                        unsigned_int64 ullEventInterest);
  HRESULT         __fastcall Close(void);
...
public:
  ...
  HRESULT         __fastcall RemovePronunciation(LPWSTR pszWord/*[in]*/, 
                                                 ...
                                                 Speechlib_tlb::SPPARTOFSPEECH ePartOfSpeech/*[in]*/, 
                                                 LPWSTR pszPronunciation/*[in]*/);
  HRESULT         __fastcall GetGeneration(unsigned_long* pdwGeneration);
...
public:
  ...
  HRESULT         __fastcall SetLangId(unsigned_short LangId);
  HRESULT         __fastcall SAPI2UPS(unsigned_short* pszSAPIId/*[in]*/, 
                                      unsigned_short* pszUPSId/*[out]*/, unsigned_long cMaxLength);
  HRESULT         __fastcall UPS2SAPI(unsigned_short* pszUPSId/*[in]*/, 
                                      unsigned_short* pszSAPIId/*[out]*/, unsigned_long cMaxLength);
  HRESULT         __fastcall GetMaxConvertLength(unsigned_long cSrcLength, long bSAPI2UPS, 
...
template <class T> HRESULT __fastcall
TCOMISpeechAudioFormatT<T>::GetWaveFormatEx(Speechlib_tlb::ISpeechWaveFormatEx** WaveFormatEx/*[out,retval]*/)
{
  return (*this)->GetWaveFormatEx(WaveFormatEx);
}

template <class T> Speechlib_tlb::ISpeechWaveFormatEx* __fastcall
TCOMISpeechAudioFormatT<T>::GetWaveFormatEx(void)
{
  Speechlib_tlb::ISpeechWaveFormatEx* WaveFormatEx;
  OLECHECK(this->GetWaveFormatEx((Speechlib_tlb::ISpeechWaveFormatEx**)&WaveFormatEx));
  return WaveFormatEx;
}

template <class T> HRESULT __fastcall
TCOMISpeechAudioFormatT<T>::SetWaveFormatEx(Speechlib_tlb::ISpeechWaveFormatEx* WaveFormatEx/*[in]*/)
{
  return (*this)->SetWaveFormatEx(WaveFormatEx);
}
...
template <class T> HRESULT __fastcall
ISpeechAudioFormatDispT<T>::GetWaveFormatEx(Speechlib_tlb::ISpeechWaveFormatEx** WaveFormatEx/*[out,retval]*/)
{
  _TDispID _dispid(*this, OLETEXT("GetWaveFormatEx"), DISPID(3));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr((LPDISPATCH*)(Speechlib_tlb::ISpeechWaveFormatEx**)WaveFormatEx /*[VT_USERDEFINED:2]*/, _args, OleFunction(_dispid, _args));
}
...
{
  Speechlib_tlb::ISpeechWaveFormatEx* WaveFormatEx;
  this->GetWaveFormatEx((Speechlib_tlb::ISpeechWaveFormatEx**)&WaveFormatEx);
  return WaveFormatEx;
}

template <class T> HRESULT __fastcall
ISpeechAudioFormatDispT<T>::SetWaveFormatEx(Speechlib_tlb::ISpeechWaveFormatEx* WaveFormatEx/*[in]*/)
{
  _TDispID _dispid(*this, OLETEXT("SetWaveFormatEx"), DISPID(4));
  TAutoArgs<1> _args;
  _args[1] = (LPDISPATCH)(Speechlib_tlb::ISpeechWaveFormatEx*)WaveFormatEx /*[VT_USERDEFINED:1]*/;
  return OleFunction(_dispid, _args);
}
...
template <class T> HRESULT __fastcall
TCOMISpNotifyTranslatorT<T>::InitWin32Event(void* hEvent, long fCloseHandleOnRelease)
{
...
// *********************************************************************//
template <class T> HRESULT __fastcall
TCOMISpStreamT<T>::SetBaseStream(Speechlib_tlb::IStream* pStream, System::TGUID* rguidFormat, 
                                 Speechlib_tlb::WaveFormatEx* pWaveFormatEx)
{
...
template <class T> HRESULT __fastcall
TCOMISpStreamT<T>::GetBaseStream(Speechlib_tlb::IStream** ppStream)
{
  return (*this)->GetBaseStream(ppStream);
}

template <class T> HRESULT __fastcall
TCOMISpStreamT<T>::BindToFile(LPWSTR pszFileName, Speechlib_tlb::SPFILEMODE eMode, 
                              System::TGUID* pFormatId, Speechlib_tlb::WaveFormatEx* pWaveFormatEx, 
                              unsigned_int64 ullEventInterest)
{
...
template <class T> HRESULT __fastcall
TCOMISpLexiconT<T>::GetGeneration(unsigned_long* pdwGeneration)
{
...
template <class T> HRESULT __fastcall
TCOMISpShortcutT<T>::GetGeneration(unsigned_long* pdwGeneration)
{
  return (*this)->GetGeneration(pdwGeneration);
}
...
template <class T> HRESULT __fastcall
TCOMISpPhoneticAlphabetConverterT<T>::SetLangId(unsigned_short LangId)
{
...
template <class T> HRESULT __fastcall
TCOMISpPhoneticAlphabetConverterT<T>::GetMaxConvertLength(unsigned_long cSrcLength, long bSAPI2UPS, 
                                                          unsigned_long* pcMaxDestLength/*[out]*/)
{
